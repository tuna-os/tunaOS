...
| :--- | ---: | :--- | :--- | :--- |
| 🐠 `yellowfin` | **15/19** | [❌ 2026-09-12](https://github.com/tuna-os/tunaOS/actions/runs/34705563513) | — | gnome,gnome-hwe,gnome-nvidia,gnome-nvidia-hwe |
| 🐟 `albacore` | **18/19** | [❌ 2026-09-12](https://github.com/tuna-os/tunaOS/actions/runs/34680156460) | — | gnome-nvidia-hwe |
...
| 🎣 `bonito` | **14/16** | [❌ 2026-09-12](https://github.com/tuna-os/tunaOS/actions/runs/34698471718) | — | base-nvidia,gnome-t2 |
| 🐦 `hummingbird` | **2/3** | [❌ 2026-09-12](https://github.com/tuna-os/tunaOS/actions/runs/34661391637) | — | gnome |
| 🦈 `sailfin` | **0/7** | [❌ 2026-09-12](https://github.com/tuna-os/tunaOS/actions/runs/34720071388) | — | base,gnome,gnome-asahi,kde,niri,xfce,cosmic |
| 🌈 `guppy` | **3/3** | [✅ 2026-09-12](https://github.com/tuna-os/tunaOS/actions/runs/34689572510) | — | — |
| 🐉 `bonito-rawhide` | **14/14** | [❌ 2026-09-12](https://github.com/tuna-os/tunaOS/actions/runs/34709168489) | — | — |
| 🐟 `gurnard` | **2/2** | [✅ 2026-09-12](https://github.com/tuna-os/tunaOS/actions/runs/34683905772) | — | — |
| 🐟 `grouper` | **6/7** | [❌ 2026-09-12](https://github.com/tuna-os/tunaOS/actions/runs/34714039087) | — | gnome-zfs |
| 🚀 `marlin` | **16/16** | [❌ 2026-09-12](https://github.com/tuna-os/tunaOS/actions/runs/34704994665) | — | — |
| 🐡 `flounder` | **5/5** | [❌ 2026-09-11](https://github.com/tuna-os/tunaOS/actions/runs/34657636354) | — | — |
| ☢️ `flounder-sid` | **7/7** | [✅ 2026-09-12](https://github.com/tuna-os/tunaOS/actions/runs/34663871316) | — | — |
...
| :--- | :--- | :--- | :--- |
| 🏔️ `ghcr.io/tuna-os/tromso` | [tromso](https://github.com/tuna-os/tromso) | KDE | [❌ 2026-09-12](https://github.com/tuna-os/tromso/actions/runs/34674094522) |
| 🐭 `ghcr.io/tuna-os/xfce-linux` | [xfce-linux](https://github.com/tuna-os/xfce-linux) | XFCE | [❌ 2026-09-12](https://github.com/tuna-os/xfce-linux/actions/runs/34664484283) |

**Built 118/139 · composite green 74/139 (84% built)** — The remainder has **0 failures** and **21 never reached**; no job asserted the latter. We show the two values separately. A cell with no job has no test, but it can still work.
