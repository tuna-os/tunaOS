...
| **External contributor onboarding / Hacktoberfest 2026** | guide / strategist | #1331, #1347, #1354, #1537 | 🟡 In progress — **T-8 recorded ~6 usable seeds; live recount on 08-14 found 9 open labeled seeds** (tunaos 2, docs 6, protota 1) vs **20+ across 8 target repos** needed by the **09-15 seeding deadline** (#1537). **#1354's 3→8 target across tunaos+docs is met**, but the broader pool is not. Zero curated GFI remains in **gtk-office-suite, tunaos-packages, wootc**; `corral` has zero viable candidates; `bootc-installer` has issues disabled entirely (#1531); `letters` is archived. The former tracker #1362 closed 08-14 while its broader target was unmet; [docs/HACKTOBERFEST-2026.md](docs/HACKTOBERFEST-2026.md) and #1537 are now the live gap record. |
