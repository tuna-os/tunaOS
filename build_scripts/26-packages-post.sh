...
/usr/bin/dracut --tmpdir /tmp --no-hostonly --kver "$QUALIFIED_KERNEL" --reproducible --zstd -v --add ostree --omit "tpm2-tss pcsc" -f "/lib/modules/$QUALIFIED_KERNEL/initramfs.img"
