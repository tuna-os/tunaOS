...
For queue-level policy (SLA tiers, when to close a bot-filed issue, milestone-vs-backlog signal) see [TRIAGE-POLICY.md](../../TRIAGE-POLICY.md) — this file only maps individual-issue labels.
