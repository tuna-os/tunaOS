...
The project removed the old in-repo mdBook (`docs/book/`) when tunaos.org launched.
The book duplicated user-facing content. (The project retired the deploy workflow
for GitHub Pages separately.)
...
- [`RFC-PROCESS.md`](../RFC-PROCESS.md) — how authors propose, review, and decide RFCs
...
- [`FEDORA-BASE-POLICY.md`](../FEDORA-BASE-POLICY.md) — adopted sequence for Fedora variants (#1171)
- [`VERSIONING.md`](../VERSIONING.md) — tag scheme and stability tiers
- [`MIGRATION.md`](../MIGRATION.md) — switch from other distributions
- [`SECURITY.md`](../SECURITY.md) — vulnerability report process and supported versions
