...
| Redfin (RHEL 10) alpha | #1123 | ci-maintainer | Local-build alpha shipped (#609/#1182/#1219); keep the documented RHEL licensing/credential constraint on public CI | 🟢 shipped locally; no public CI/publish path by design |
...
- **Enterprise posture**: ADOPTERS.md empty vs Q4 "Mature" claim (#1348); RHEL10/AlmaLinux topics on repo and Redfin's local-build alpha is documented (#1123); branch protection unverified (#1167).
...
| #1123 Redfin alpha | **RECORDED AS SHIPPED** | Local-build alpha shipped via #609/#1182/#1219. Keep public CI/publishing excluded because RHEL redistribution and runner credentials are unavailable. |
...
|------|-------------------------------|-------|------------------------|------|
| #272 Bonito GA | ⬜ | | | |
| #1123 Redfin alpha | ✅ Shipped locally; public CI/publish intentionally excluded | ci-maintainer | #609/#1182/#1219 | 2026-08-09 |
| #1093 RFC governance | ⬜ | | | |
| #1094 ADR coverage | ⬜ | | | |
