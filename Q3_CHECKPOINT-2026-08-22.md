...
=======
| GFI pool (#1362) | ZERO usable | **~8 usable seeds** — tunaos #1496/#1351, docs #204/#158/#157, protota #193 (verified 08-14); **+2 converted to merged PRs by external humans same day** (docs #234/#239) — conversion loop proven (#1537) | label search |
>>>>>>> 730d81df ([strategist] planning: add merge-eligible==done scoring rule + T-7 merge-jam refresh to Q3 checkpoint (#1683))
